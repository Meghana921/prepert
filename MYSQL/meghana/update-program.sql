...
CALL update_learning_program(
  ...
  'Comprehensive 6-month program covering machine learning and big data', -- in_description
  15,                                                     -- in_creator_id
  'high',                                                 -- in_difficulty_level
  '/images/programs/data-science-advanced.jpg',           -- in_image_path
  2999.99,                                                -- in_price
  5,                                                      -- in_access_period_months
  50,                                                     -- in_available_slots
  TRUE,                                                   -- in_campus_hiring
  FALSE,                                                  -- in_sponsored
  75,                                                     -- in_minimum_score
  '2',                                                    -- in_experience_from
  '5',                                                    -- in_experience_to
  'Bangalore,Hyderabad,Remote',                           -- in_locations
  'TechCorp Analytics',                                   -- in_employer_name
  'We appreciate your application but require more experience for this program', -- in_regret_message
  7,                                                      -- in_eligibility_template_id
  12   ,        
  null 
);